        ...
        currentModal=<div className='row'>
            ...
            {   
                ...
                addresses.map(address =>{ 
                    ...
                    let classes = ['card', 'rounded', 'row', 'd-flex', 'justify-content-center', 'flex-row'];
                    if(id === address){
                        classes.push('border border-info');
                    }
               return (<div style={{cursor: 'pointer'}} className="col-12 col-sm-12 mb-4" key={address} onClick={this.selectAddress.bind(this,address)}>

                   <div className={classes.join(' ')}>
                    <div className="col-8 text-center card-body">
                           <address>
                               <strong>
                                   <p>{addr['houseNo']}, {addr['apartmentName']}</p>
                                   <p>{addr['locality']}, {addr['streetName']}</p>
                                   <p>{addr['landmark']}</p>
                                   <p>{addr['pincode']}</p>
                               </strong>
                           </address>
